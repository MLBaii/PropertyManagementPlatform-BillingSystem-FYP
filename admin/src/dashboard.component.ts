  ...
  template: `
    @if (summary) {
      ...
      <section class="dashboard-grid">
        ...
        <article class="dashboard-card overdue-card"><div class="card-head"><div><h2>Top outstanding units</h2><p>Highest unpaid balances</p></div><span class="badge-blue">Bills</span></div>
        ...
        <article class="dashboard-card aging-card"><div class="card-head"><div><h2>Aging summary</h2><p>Outstanding balance by age</p></div><span class="badge-blue">Report</span></div>
